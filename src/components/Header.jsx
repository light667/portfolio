...
import { Menu, X, Languages, Github, Linkedin } from 'lucide-react';
...
const Header = () => {
  ...
  const socialLinks = [
    { icon: <Github size={18} />, href: 'https://github.com/light667', label: 'GitHub' },
    { icon: <Linkedin size={18} />, href: 'https://www.linkedin.com/in/kokou-light-djossou-90216233b/', label: 'LinkedIn' },
  ];
