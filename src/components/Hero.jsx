      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 border border-white/20 rounded-full font-bold hover:bg-white/5 transition-all flex items-center gap-2 text-slate-300 cursor-pointer"
            >
              Portfolio PDF
              <Download size={18} />
            </motion.a>
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute top-10 -left-12 glass-card px-4 py-2 border-neon-cyan/30 z-20"
          >
          ...
          <motion.div 
            ...
            className="absolute bottom-10 -right-12 glass-card px-4 py-2 border-neon-purple/30 z-20"
          >
          ...
          <motion.div 
            ...
            className="absolute top-1/2 -left-20 glass-card px-4 py-2 border-neon-lime/30 z-20"
          >
          ...
          <motion.div 
            ...
            className="absolute top-1/2 -right-20 glass-card px-4 py-2 border-blue-500/30 z-20"
          >
            <span className="text-[10px] font-bold text-blue-500 uppercase">Data Scientist</span>
          </motion.div>
